  ...
  return (
    <footer>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '24px', marginBottom: '1.5rem' }}>
        ...
        <img src="/logos/jpura_voice_logo.png" alt="J'PURA VOICE" style={{ height: '95px', width: 'auto', objectFit: 'contain' }} />
        <img src="/logos/announcing_division_logo.png" alt="Announcing Division" style={{ height: '95px', width: 'auto', objectFit: 'contain' }} />
      </div>
